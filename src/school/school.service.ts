...
export class SchoolService {
  ...
  async getParentSchools(parentId: string) {
    // Get schools where the parent's children are currently enrolled
    ...
    // Extract unique schools from all children across all school relationships
