...
export declare class CreatorHistoryService {
    private prisma;
    constructor(prisma: PrismaService);
    getCreatorHistory(creatorId: string, params?: {
        skip?: number;
        take?: number;
        startDate?: Date;
        endDate?: Date;
    ...
    getHistoryAnalytics(creatorId: string, params?: {
        startDate?: Date;
        endDate?: Date;
    }): Promise<{
        totalContent: number;
    ...
    unpublishFromMarketplace(creatorId: string, contentId: string): Promise<{
        description: string;
        title: string;
        id: string;
        createdAt: Date;
    ...
    getContentPerformance(creatorId: string, contentId: string): Promise<{
        marketplaceItem: {
            description: string;
            title: string;
            isActive: boolean;
