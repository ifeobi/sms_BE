...
const academic_structure_service_1 = require("../academic-structure/academic-structure.service");
...
let AuthService = class AuthService {
    ...
    constructor(usersService, jwtService, emailService, prisma, academicStructureService) {
    ...
    getEducationSystemIdByCountry(country) {
        const countryToSystemMap = {
            NG: 'nigeria-6334',
            GH: 'ghana-6334',
            KE: 'kenya-844',
        };
        return countryToSystemMap[country] || 'nigeria-6334';
    }
    getAvailableLevelsForCountry(country) {
        const educationSystemId = this.getEducationSystemIdByCountry(country);
        const system = this.academicStructureService.getEducationSystemById(educationSystemId);
        if (!system)
            return [];
...
exports.AuthService = AuthService = __decorate([
    ...
    __metadata("design:paramtypes", [users_service_1.UsersService,
        ...
        academic_structure_service_1.AcademicStructureService])
], AuthService);
