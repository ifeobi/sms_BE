...
export declare class AuthService {
    ...
    private prisma;
    private academicStructureService;
    constructor(usersService: UsersService, jwtService: JwtService, emailService: EmailService, prisma: PrismaService, academicStructureService: AcademicStructureService);
    ...
    private getEducationSystemIdByCountry;
    private getAvailableLevelsForCountry;
}
