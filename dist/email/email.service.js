...
let EmailService = class EmailService {
    ...
    async sendVerificationEmail(email, code, userName, userType) {
        try {
            ...
            console.log('===================');
            const htmlContent = this.getVerificationEmailTemplate(userName, code, userType);
    ...
    async sendPasswordResetEmail(email, resetToken, userName, userType) {
        try {
            console.log('=== PASSWORD RESET EMAIL DEBUG ===');
            console.log('Sending password reset email to:', email);
            console.log('Reset token:', resetToken);
            console.log('===================================');
            const htmlContent = this.getPasswordResetEmailTemplate(userName, resetToken, userType);
            await this.mailerService.sendMail({
                to: email,
    ...
    getVerificationEmailTemplate(userName, code, userType) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getWelcomeEmailTemplate(userName, userType) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getPasswordResetEmailTemplate(userName, resetToken, userType) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getStudentWelcomeEmailTemplate(data) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getParentWelcomeEmailTemplate(data) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getParentInvitationEmailTemplate(data) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
